...
<head>
    ...
    <title>I Tee | Product Update</title>
</head>
<body>
                ...
                <div class="row" id="main" >
                    <?php
                        ...
                        require('open-connection.php');
                            $strsql = "SELECT * FROM product_lists WHERE id = ".$_SESSION['k'];
                        ...
                        if(isset($_POST['btnUpdate'])){
                            ...
                            $photo1 = $fileName1;
                            $photo2 = $fileName2;
                            $strsql = "UPDATE product_lists SET name='$pname', 
                                                                price='$price',
